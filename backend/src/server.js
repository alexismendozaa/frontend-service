...
app.use(cors({
  origin: process.env.CLIENT_ORIGIN || 'http://54.234.57.7:5173', // Variable de entorno o localhost para desarrollo
...
const swaggerOptions = {
  swaggerDefinition: {
    ...
    servers: [
      { url: process.env.CLIENT_ORIGIN || 'http://54.234.57.7:5173' },
    ],
  },
  apis: ['./routes/*.js'],
};
